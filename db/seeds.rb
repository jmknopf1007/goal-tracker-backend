...
o2 = Objective.create(title: "Learn Ruby", user_id: tia.id)
o3 = Objective.create(title: "Learn Java", user_id: matt.id)
...
g5 = Goal.create(description: "Complete 3 labs", category: "daily", day_count: 0, objective_id: o2.id)
g6 = Goal.create(description: "Complete 2 quizzes", category: "daily", day_count: 0, objective_id: o2.id)
g7 = Goal.create(description: "Learn 5 new coding concepts", category: "daily", day_count: 0, objective_id: o2.id)
g8 = Goal.create(description: "Complete next unit test", category: "weekly", day_count: 0, objective_id: o2.id)
